...
Modulo compartilhado da camada base (codex-image). Outros plugins descobrem
este arquivo em runtime subindo a arvore de diretorios a partir do proprio
script — ver spritekit.py (codex-sprite) para o mecanismo de fallback e a
mensagem de degradacao quando codex-image nao esta instalado.
"""
import json
import os
import re
