...
Rode `python3 "${CLAUDE_PLUGIN_ROOT}/scripts/spritekit.py" <subcomando> ...` com os caminhos do projeto atual e confirme os arquivos gerados. Se a paleta for pixel art e o Aseprite estiver configurado (`/codex-sprite:setup`), o `pixelate` usa o motor Aseprite automaticamente.
