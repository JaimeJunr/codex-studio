...
- Sem o pixel-plugin/Aseprite → **degrade**: entregue o sprite estático (`codex-sprite:sprite`) + `walkgen` procedural, e diga que a edição avançada precisa do pixel-plugin.

## Fluxo de handoff

1. **Gere o estático** (camada 1): `codex-image:generate` com `engine: grok` (sprite) → PNG.
