---
name: study-deck
description: Monta materiais de estudo visuais — deck de aula, resumo visual de um tema, flashcards em imagem, e deck de defesa/apresentação acadêmica. Fornece a estrutura pedagógica; delega geração/montagem ao codex-deck/codex-image. Use pra transformar matéria, artigo ou notas em material de estudo.
---

# codex-study:study-deck — materiais de estudo

Especialização de estudo sobre o `codex-deck`. Transforma matéria/artigo/notas em material que ensina, não só que "mostra".

## Requisito
`codex-deck` + `codex-image`. Sem eles, entregue a estrutura pro usuário montar.
...
3. Passe pro `codex-deck:deck`. Estilo sugerido: `quadro-branco-desenhado` (didático) ou `e-ink-revista`/`limpo-profissional` (acadêmico).
