...
Fundamentos pra pixel art *de verdade* (grid inteiro + placement intencional), não o "look blocado" borrado que a IA cospe por padrão. Complementa `codex-sprite/references/sprites.md` (convenções de sheet/engine).
